 ...
 *
 * - Feature flags derived from ATOM_CXX_STANDARD
 *   - ATOM_HAS_CXX26
 *   - ATOM_HAS_CXX23
 *   - ATOM_HAS_CXX20
 *   - ATOM_HAS_CXX17
 ...
 */
#ifndef ATOM_QRK_SYSTEM_CPP_H
#define ATOM_QRK_SYSTEM_CPP_H

/** Warn when the header is included from non-C++ code. */
#if !defined(__cplusplus) && !defined(_MSVC_LANG)
#    pragma message("Atom is a C++-only header. Do not include it from C projects")
#endif

/** Marker that this codebase expects C++ compilation. */
#define ATOM_LANGUAGE_CXX 1

/** C++ standard version detection and feature gating. */

/** Prefer _MSVC_LANG under MSVC, otherwise use __cplusplus. */
#if defined(_MSVC_LANG)
#    define ATOM_CXX_STANDARD _MSVC_LANG
#else
#    define ATOM_CXX_STANDARD __cplusplus
#endif

/** C++26 or later. */
#if ATOM_CXX_STANDARD >= 202602L
#    define ATOM_HAS_CXX26 1
#endif

/** C++23 or later. */
#if ATOM_CXX_STANDARD >= 202302L
#    define ATOM_HAS_CXX23 1
#endif

/** C++20 or later. */
#if ATOM_CXX_STANDARD >= 202002L
#    define ATOM_HAS_CXX20 1
#endif

/** C++17 or later. */
#if ATOM_CXX_STANDARD >= 201703L
#    define ATOM_HAS_CXX17 1
#endif

/** C++14 or later. */
#if ATOM_CXX_STANDARD >= 201402L
#    define ATOM_HAS_CXX14 1
#endif

/** C++11 or later. */
#if ATOM_CXX_STANDARD >= 201103L
#    define ATOM_HAS_CXX11 1
#endif

/** C++98/03 or later. */
#if ATOM_CXX_STANDARD >= 199711L
#    define ATOM_HAS_CXX98 1
#endif
