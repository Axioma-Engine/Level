...
AXM_STATIC_ASSERT(sizeof(u8) == 1, "AXM: u8  must be 1 byte")
AXM_STATIC_ASSERT(sizeof(u16) == 2, "AXM: u16 must be 2 bytes")
AXM_STATIC_ASSERT(sizeof(u32) == 4, "AXM: u32 must be 4 bytes")
AXM_STATIC_ASSERT(sizeof(u64) == 8, "AXM: u64 must be 8 bytes")

AXM_STATIC_ASSERT(sizeof(i8) == 1, "AXM: i8  must be 1 byte")
AXM_STATIC_ASSERT(sizeof(i16) == 2, "AXM: i16 must be 2 bytes")
AXM_STATIC_ASSERT(sizeof(i32) == 4, "AXM: i32 must be 4 bytes")
AXM_STATIC_ASSERT(sizeof(i64) == 8, "AXM: i64 must be 8 bytes")
